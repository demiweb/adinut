...
let srchBtn = [...document.querySelectorAll('.search-btn')];
let hiddenSearch = document.querySelector('.hidden-search');
let sideControl = document.querySelector('.header-side-control');

function searchContol() {
    if (srchBtn.length) {
        srchBtn.forEach((btn) => {
            btn.addEventListener('click', (e) => {
                e.preventDefault();
                ...
                hiddenSearch.classList.add('open');
                sideControl.classList.add('hide');
            })
        });
        hiddenSearch.querySelector('.cls').addEventListener('click', () => {
            hiddenSearch.classList.remove('open');
            sideControl.classList.remove('hide');
            srchBtn.forEach((btn) => {
...
let clickerFooter = [...document.querySelectorAll('.footer-click > span')];

function clickFooterColumn() {
    if (clickerFooter.length) {
        clickerFooter.forEach((btn) => {
            btn.addEventListener('click', () => {
                btn.closest('.footer-click').classList.toggle('open');
            })
        })
    }
}
...
let homeHeroSlider = [...document.querySelectorAll('.home-hero__cont')];
...
let catalogSlider = [...document.querySelectorAll('.catalog-slider')];
...
let productsSlider = [...document.querySelectorAll('.products-slider')];
...
let colorsSlider = [...document.querySelectorAll('.colors')];

function startColorsSlider() {
    if (!colorsSlider.length) {

    } else {


        colorsSlider.forEach((sld) => {
            let sldCont = sld.querySelector('.swiper');
...
let productSlider = [...document.querySelectorAll('.product-images')];
